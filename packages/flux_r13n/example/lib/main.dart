...
import 'package:flux_r13n/flux_r13n.dart';
    ...
    return Regionalizations(
      ...
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
              title: Text(context.flux_r13n.region.regionalCode),
            ),
            body: Center(
              child: Column(
                children: [
                  DropdownButton<Region>(
                    value: context.flux_r13n.region,
                    items: const [
                      DropdownMenuItem(
                  ...
                  Text('Support email: ${context.flux_r13n.supportEmail}'),
                ],
              ),
            ),
          );
