...
/// * [blockNumber] 
/// * [logIndex] 
abstract class OrderActivityCancelList implements Built<OrderActivityCancelList, OrderActivityCancelListBuilder> {
    ...
    factory OrderActivityCancelList([void updates(OrderActivityCancelListBuilder b)]) = _$OrderActivityCancelList;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrderActivityCancelList> get serializer => _$OrderActivityCancelListSerializer();
}

class _$OrderActivityCancelListSerializer implements StructuredSerializer<OrderActivityCancelList> {
    @override
    final Iterable<Type> types = const [OrderActivityCancelList, _$OrderActivityCancelList];

    @override
    final String wireName = r'OrderActivityCancelList';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrderActivityCancelList object,
    ...
    @override
    OrderActivityCancelList deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
            ...
            switch (key) {
                case r'@type':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(OrderActivityCancelListAtTypeEnum)) as OrderActivityCancelListAtTypeEnum;
...
class OrderActivityCancelListAtTypeEnum extends EnumClass {
  ...
  static const OrderActivityCancelListAtTypeEnum cancelList = _$orderActivityCancelListAtTypeEnum_cancelList;

  static Serializer<OrderActivityCancelListAtTypeEnum> get serializer => _$orderActivityCancelListAtTypeEnumSerializer;

  const OrderActivityCancelListAtTypeEnum._(String name): super(name);

  static BuiltSet<OrderActivityCancelListAtTypeEnum> get values => _$orderActivityCancelListAtTypeEnumValues;
  static OrderActivityCancelListAtTypeEnum valueOf(String name) => _$orderActivityCancelListAtTypeEnumValueOf(name);
}
