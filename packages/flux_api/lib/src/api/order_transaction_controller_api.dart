...
class OrderTransactionControllerApi {

  final Dio _dio;

  final Serializers _serializers;

  const OrderTransactionControllerApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<LogEvent>>> createOrderPendingTransaction({ 
    ...
    final _path = r'/v0.1/order/transactions';
