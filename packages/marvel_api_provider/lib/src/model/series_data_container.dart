...
abstract class SeriesDataContainer
    implements
        Built<SeriesDataContainer, SeriesDataContainerBuilder>,
        BaseModel {
  ...
  static void _initializeBuilder(SeriesDataContainerBuilder b) => b;

  factory SeriesDataContainer([void updates(SeriesDataContainerBuilder b)]) =
  ...
  static SeriesDataContainer fromJson(Map<String, dynamic> json) {
...
class _$SeriesDataContainerSerializer
  ...
  @override
  final String wireName = r'SeriesDataContainer';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, SeriesDataContainer object,
    ...
    if (object.results != null) {
      result
        ...
        ..add(serializers.serialize(object.results,
            specifiedType: const FullType(BuiltList, [FullType(Series)])));
    }
    return result;
  }

  @override
  SeriesDataContainer deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = SeriesDataContainerBuilder();
