...
class XDateTimeSerializer implements PrimitiveSerializer<DateTime> {
  final bool structured = false;

  Iterable<Type> get types => BuiltList.of([DateTime]);
  ...
  DateTime deserialize(
    ...
    if (serialized is String &&
        !(serialized.endsWith('+00:00') || serialized.endsWith('Z'))) {
      serialized += 'Z';
    }
