...
let PassThroughService = class PassThroughService {
    constructor(logger, program, versionManager, generatorService) {
        ...
        this.passThrough = (args = [], customGenerator) => Object(child_process__WEBPACK_IMPORTED_MODULE_7__["spawn"])(this.cmd(customGenerator), args, {
            stdio: 'inherit',
            shell: true
    ...
    cmd(customJarPath = '') {
        ...
        const subCmd = customJarPath
            ...
            : `-jar "${cliPath}"`;
        return ['java', process.env['JAVA_OPTS'], subCmd].filter(lodash__WEBPACK_IMPORTED_MODULE_4__["isString"]).join(' ');
    }
};
