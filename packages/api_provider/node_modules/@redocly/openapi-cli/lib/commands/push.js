...
function handlePush(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!isAuthorized) {
            const clientToken = yield utils_1.promptUser(colorette_1.green(`\n  🔑 Copy your API key from ${colorette_1.blue('https://app.redoc.ly/profile')} and paste it below`), true);
  ...
  ${colorette_1.yellow('Suggestion:')} please use ${colorette_1.blue('-u')} or ${colorette_1.blue('--upsert')} to create definition.
    `);
        ...
        if (version) {
            ...
            yield client.createDefinitionVersion(definitionId, apiVersion, PUSH_SOURCE_TYPE, updatePatch.source);
        }
        ...
        function collectAndUploadFiles(branch) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let file of filesToUpload.files) {
                    ...
                    const uploadResponse = yield uploadFileToS3(signedFileUrl, file.contents || file.filePath);
