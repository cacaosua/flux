    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const entryPoint of entrypoints) {
            try {
                ...
                process.stderr.write(colorette_1.gray(`validating ${entryPoint.replace(process.cwd(), '')}...\n`));
                ...
                process.stderr.write(colorette_1.gray(`${entryPoint.replace(process.cwd(), '')}: validated in ${elapsed}\n\n`));
            }
            catch (e) {
                totals.errors++;
